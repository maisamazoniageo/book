...
m =floresta_ac[['OBJECTID', 'nome', 'orgao', 'classe', 'estagio', 'governo', 'codigo','ano', 'uf', 'protecao', 'tipo','categoria', 'observacao', 'sobreposic', 'bioma', 'area_ha', 'area-estudo', 'geometry']].explore(name='Florestas Publicas')
glebas[glebas['uf']=='AC'].explore(m=m, name='Glebas', color="red")

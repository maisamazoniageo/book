...
for item in lista:
    ...
    municipio_gleba.plot(ax=ax, column='nm_mun', categorical=True,
                        ...
                        'bbox_to_anchor':(0.5,-0.15),'ncols':3}, aspect=1)
    gleba.plot(ax=ax, facecolor='none', edgecolor='black', linewidth=2, aspect=1)
    ...
    uc=gpd.read_file('../glebas-federais.gpkg', layer='uc-Amazonas')
    ...
    ti=gpd.read_file('../glebas-federais.gpkg', layer='ti-Amazonas')
    ...
    pa = gpd.read_file('../glebas-federais.gpkg', layer='pa-Amazonas')
    ...
    sigef = gpd.read_file('../glebas-federais.gpkg', layer='sigef-Amazonas')
    ...
    snci = gpd.read_file('../glebas-federais.gpkg', layer='snci-Amazonas')
